...
concat = ("Give a short yet detailed road recommendation to enhance Malabon LGU Road Decision Making.\n"
"Ex.: Road rehabilitation must move to..., or any road activity must move to..."
)
...
Today {today[:10]}: total of {t_sum:,} Vehicles\n\
